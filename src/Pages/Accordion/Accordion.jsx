        ...
        <div id="accordion-collapse" data-accordion="collapse">
            ...
            <div className='1 border-b border-gray-200' id="accordion-collapse-heading-1">
                <button
                    ...
                    <span className='font-semibold'>{t('Sizning mahsulotlaringizning saqlash muddati qancha?')}</span>
            ...
            <div
                ...
                <p>{t('Biz zamonaviy evropa texnologiyalari va uskunalaridan foydalanamiz, bu bizning mahsulotlarimizning yuqori sifatini kafolatlaydi.')}</p>
            </div>
            ...
            <div className='2 border-b border-gray-200' id="accordion-collapse-heading-1">
                <button
                    ...
                    <span className='font-semibold'>{t("Ishlab chiqarishda qaysi texnologiyalar qo'llaniladi?")}</span>
            ...
            <div className='3 border-b border-gray-200' id="accordion-collapse-heading-1">
                <button
                    ...
                    <span className='font-semibold'>{t('Qanday tarkibiy qismlar ishlatiladi?')}</span>
            ...
            <div className='4 border-b border-gray-200' id="accordion-collapse-heading-1">
                <button
                    ...
                    <span className='font-semibold'>{t('Sizning mahsulotlaringizni qayerdan xarid qilishim mumkin?')}</span>
